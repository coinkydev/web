/// Ported 1:1 from `coinky-web/translations.js`.
///
/// Structure:
/// - Top-level keys are language codes: `en`, `pt`, `es`.
/// - Each language maps flat string keys (e.g. `nav_features`) to a
///   `String` value, EXCEPT `showcase_data`, which is a nested
///   `Map<String, dynamic>` keyed "01".."04", each holding
///   `{title: String, desc: String, list: List<String>}`.
///
/// Keep this file byte-for-byte in sync with `translations.js` whenever the
/// marketing copy changes. Do not restructure — other components rely on
/// the exact key names below via `t(context, key)` (see `i18n_state.dart`).
const Map<String, Map<String, dynamic>> translations = {
    ...
    'showcase_data': {
      ...
      '02': {
        ...
        'list': [
          ...
          'Avisos de faturas não pagas de ciclos anteriores',
        ],
      },
      '03': {
        ...
        'list': [
          ...
          'Comparativo de orçamento definido vs gastos reais',
        ],
      },
      '04': {
  ...
  'es': {
    ...
    'feature_1_desc':
        'Sigue fechas de cierre, vencimiento, límites mensuales y recibe alertas de facturas pendientes anteriores.',
    ...
    'showcase_data': {
      ...
      '02': {
        ...
        'list': [
          ...
          'Avisos de facturas no pagadas de ciclos anteriores',
        ],
      },
      '03': {
        ...
        'list': [
          ...
          'Desglose de presupuesto vs gasto real',
        ],
      },
      '04': {
        ...
        'list': [
          ...
          'Preferencias de modo claro y oscuro',
        ],
      },
    },
